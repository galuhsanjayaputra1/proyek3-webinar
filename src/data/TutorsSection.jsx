export const tutorsSection = {
    content: ` <p className="deskripsi">Our Top Tutors</p>
              <h2>Tutors</h2>
              <p>Tutors di Webinar ULBI adalah para pengajar berpengalaman yang terdiri dari dosen, praktisi industri, serta profesional di bidangnya. Mereka hadir untuk membimbing peserta melalui materi yang terstruktur, relevan, dan mudah dipahami. Dengan pengetahuan praktis dan wawasan terbaru dari dunia kerja, para tutor memastikan setiap peserta mendapatkan pengalaman belajar yang berkualitas, interaktif, dan aplikatif.</p>`,
